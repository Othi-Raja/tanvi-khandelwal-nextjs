          ...
          <div className="total">
            ...
            {/* <div className="left_details">
              <div
                ...
                data-img-url="img/testimonials/icons8-celebrate-48.png"
              />
              <div
                className="det_image two wow fadeIn"
                data-wow-duration="1s"
                data-wow-delay="0.2s"
                data-img-url="img/testimonials/icons8-heart-48.png"
              />
              <div
                className="det_image three wow fadeIn"
                data-wow-duration="1s"
                data-wow-delay="0.4s"
                data-img-url="img/testimonials/icons8-facebook-like-50.png"
              />
              <div
                className="det_image four wow fadeIn"
                data-wow-duration="1s"
                data-wow-delay="0.6s"
                data-img-url="img/testimonials/icons8-clapping-hands-light-skin-tone-48.png"
              />
            ...
            {/* <div className="right_details">
              <div
                className="det_image one wow fadeIn"
                data-wow-duration="1s"
                data-img-url="img/testimonials/icons8-bullseye-48.png"
              />
              <div
                className="det_image two wow fadeIn"
                data-wow-duration="1s"
                data-wow-delay="0.2s"
                data-img-url="img/testimonials/icons8-sparkles-48.png"
              />
              <div
                className="det_image three wow fadeIn"
                data-wow-duration="1s"
                data-wow-delay="0.4s"
                data-img-url="img/testimonials/icons8-four-leaf-clover-96.png"
              />
              <span className="circle yellow animPulse" />
