...
const Home = ({ dark }) => {
  ...
  return (
    <div className="dizme_tm_section" id="home" style={{ background: 'url("img/slider/1.jpg")', backgroundSize: 'cover', minHeight: '130vh' }}>
        ...
        <div className="container">
          <div className="content">
            <div className="details">
              ...
              <div className="job">
                <p>
                  HR <span className="greenText">{data && data.mainSkill}</span>{" "}
                  Content Creator ||<span className="purpleText">{data.address}</span>
                </p>
              </div>
              <div className="text">
                <p>{data.bio}</p>
